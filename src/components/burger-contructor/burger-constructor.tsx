...
import { CHOOSE_INGRIDIENT } from '../../services/actions/actualIngridients';
...
const BurgerConstructor: FC = () => {
  ...
  return (
    <section className={burgerConstructorStyles.constructor__main}>
